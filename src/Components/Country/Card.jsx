...
function Card({ setHideComponent, setShowDetailsComponent, setShowCardComponent }) {

  setHideComponent(true) //set the hidecomponent(list,search) function variable to true when card page will render 


  const { cardDetails } = useCountryDetails();
    ...
    <>
      ...
      <div className="w-full max-w-sm mx-auto justify-center mb-4 mt-3">
        <div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <img className="p-8 rounded-t-lg" src={details?.flag} alt="product_image1" />
          <div className="px-5 pb-5">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
              {details?.country}
              <p>
                Popluation:{details?.population}
              </p>
            </h5>
